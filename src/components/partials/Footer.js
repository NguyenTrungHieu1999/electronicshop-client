              ...
              <div className="container">
                <div className="row">
                      ...
                      <div className="module-body">
                        <ul className="toggle-footer" style={{}}>
                          ...
                          <li className="media">
                            ...
                            <div className="media-body"> <span><a href="#a">marazzo@themesground.com</a></span> </div>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div className="module-body">
                      <ul className="list-unstyled">
                        <li className="first"><a href="#a" title="Contact us">My Account</a></li>
                        <li><a href="#a" title="About us">Order History</a></li>
                        <li><a href="#a" title="faq">FAQ</a></li>
                        <li><a href="#a" title="Popular Searches">Specials</a></li>
                        <li className="last"><a href="#a" title="Where is my order?">Help Center</a></li>
                      </ul>
                    </div>
                    {/* /.module-body */}
                  </div>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div className="module-body">
                      <ul className="list-unstyled">
                        <li className="first"><a title="Your Account" href="#a">About us</a></li>
                        <li><a title="Information" href="#a">Customer Service</a></li>
                        <li><a title="Addresses" href="#a">Company</a></li>
                        <li><a title="Addresses" href="#a">Investor Relations</a></li>
                        <li className="last"><a title="Orders History" href="#a">Advanced Search</a></li>
                      </ul>
                    </div>
                    {/* /.module-body */}
                  </div>
                  ...
                  <div className="col-xs-12 col-sm-6 col-md-3">
                    ...
                    <div className="module-body">
                      <ul className="list-unstyled">
                        <li className="first"><a href="#a" title="About us">Shopping Guide</a></li>
                        <li><a href="#a" title="Blog">Blog</a></li>
                        <li><a href="#a" title="Company">Company</a></li>
                        <li><a href="#a" title="Investor Relations">Investor Relations</a></li>
